...
public class ImpresionESCPOS {
    public void ImprimirDocumento(Cursor dataItems,String OriginalCopia,Integer Copias) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
      ...
      ComandoImprimir+=""+
              ...
              "[L]\n"+
                ...
                "[C]<font size='tall'>ORIGINAL</font>\n";

                for(int vueltas=1;vueltas<=Copias;vueltas++)
                {

                        printer.printFormattedText(ComandoImprimir,60);
                }
